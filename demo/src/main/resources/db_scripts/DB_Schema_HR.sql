...
CREATE TABLE TABLE IF NOT EXISTSPILOTO (
...
CREATE TABLE TABLE IF NOT EXISTS PASAJERO (
...
CREATE TABLE TABLE IF NOT EXISTS AZAFATA (
...
CREATE TABLE TABLE IF NOT EXISTS AEROPUERTO (
...
CREATE TABLE TABLE IF NOT EXISTS AVION (
...
CREATE TABLE TABLE IF NOT EXISTS VUELO (
...
CREATE TABLE TABLE IF NOT EXISTS PASAJERO_VUELO (
...
CREATE TABLE TABLE IF NOT EXISTS AZAFATA_VUELO (
...
CREATE TABLE TABLE IF NOT EXISTS CHECK_IN (

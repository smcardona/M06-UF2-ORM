...
CREATE TABLE IF NOT EXISTS VUELO (
    ...
    FOREIGN KEY (id_origen) REFERENCES AEROPUERTO(id) ON DELETE CASCADE,

    FOREIGN KEY (id_destino) REFERENCES AEROPUERTO(id) ON DELETE CASCADE,

    FOREIGN KEY (id_avion) REFERENCES AVION(id) ON DELETE CASCADE,

    FOREIGN KEY (id_piloto) REFERENCES PILOTO(persona_id) on delete cascade
...
CREATE TABLE IF NOT EXISTS PASAJERO_VUELO (
    ...
    FOREIGN KEY (id_pasajero) REFERENCES PASAJERO(persona_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS AZAFATA_VUELO (
    ...
    FOREIGN KEY (id_azafata) REFERENCES AZAFATA(persona_id) ON DELETE CASCADE,
